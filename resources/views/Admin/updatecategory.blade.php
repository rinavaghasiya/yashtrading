                ...
                <div class="login-wrap">
                  <div  style="float: left;">
                    ...
                    <form class="form-horizontal" action="{{ url('adminedit')}}" method="post">
                      ...
                      <input type="text" class="form-control" placeholder=" Category Name"   value="{{ $data->cname }}" onkeypress="return checkNum(event)"  name="cname" id="cname" ><p id="cname_validation"></p>
                      </div>
