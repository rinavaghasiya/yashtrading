...
<div class="section__content section__content--p30">
	...
	@if(Session::has('message'))
	  ...
	  <p  style="font-size:24px"><strong>SubCategory</strong></p>
	   <br>
	   <div style="float: right;">
                 <button type="submit" class="btn btn-primary"><a href="{{ url('addsubcategory') }}" style="color: white;">Add SubCategory</a></button> 
    </div>
	   <br>
                    ...
                    <table class="table table-borderless table-data3" id="myTable">
				        <thead>
				            <tr>
                                ...
                                <th><strong>SubCategory Id</strong></th>
				        ...
				        <tbody>
				        	@foreach ($data as $user)
                              ...
                              <td>{{$user->cid}}</td>
				                ...
				                <td>
				                	<a href ='updatesubcat/{{ $user->id }}'><button type="submit" class="btn btn-primary">Edit</button></a> 
				               	</td>
				               	<td>
				                	<a href ='subcategorydelete/{{ $user->id }}'><button type="submit" class="btn btn btn-danger">Delete</button></a>
				                </td>
			                 </tr>
		                 @endforeach
		                 @if(count($data)<=0)
