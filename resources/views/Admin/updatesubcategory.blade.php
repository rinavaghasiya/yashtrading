            ...
            <div class="container">
                <div class="login-wrap">
                  <div  style="float: left;">
                    ...
                    <form class="form-horizontal" action="{{ url('editsubcat')}}" method="post">
                          {{ csrf_field() }}
                      <div class="form-group">
                        <input type="hidden" class="form-control"  name="id" id="id" value="{{ $data->id }}">
                      
                        <label for="" class="col-form-label">Category</label>
                        <input type="text" class="form-control" value="{{ $data->cname }}" onkeypress="return checkNum(event)"  name="cname" id="cname" ></p>
                    </div>
                    
                      
                      <label>SubCategory Name</label>
                      <input type="text" class="form-control" value="{{ $data->subcname }}" onkeypress="return checkNum(event)"  name="subcname" id="subcname" ><p id="cname_validation"></p>
                      </div>
