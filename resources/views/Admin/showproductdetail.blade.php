                            ...
                            <div class="row">
                                ...
                                <div class="col-md-16">
                                    <aside class="panel panel-body panel-details">
                                        <ul>
                                            <li>
                                                <p class="no-margin"><strong>Category Name:</strong>{{$image->cname}} </p>
                                            </li>
                                            
                                            <li>
                                                <p class="no-margin"><strong>Sub Category Name:</strong> {{$image->subcname}}</p>
                                            </li>
                                            <li>
